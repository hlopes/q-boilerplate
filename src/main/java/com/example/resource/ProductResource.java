...
public class ProductResource {
    ...
    public Response listByPriceRange(
            ...
            @QueryParam("page") @DefaultValue("0") int page,
            @QueryParam("size") @DefaultValue("20") int size) {
        return Response.ok(productService.listByPriceRange(min, max, page, size))
                .build();
    }
    ...
    public Response createProduct(@Valid ProductDto.CreateProductRequest request, @Context UriInfo uriInfo) {
    ...
    public Response updateProduct(@PathParam("id") UUID id, @Valid ProductDto.UpdateProductRequest request) {
